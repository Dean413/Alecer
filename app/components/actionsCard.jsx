...
export const Transaction = ({ name, time, icon, amount, status, type }) => {
  const isPositive = amount.startsWith("+");

  return (
    <div className="flex justify-between  items-center ">
        <div className="flex items-center gap-4">
            <div className="w-10 h-10 mb-10 rounded-full bg-green-50  flex items-center justify-center">{icon}</div>
            <div className="mb-10">
      ...
      <div className="text-right mb-10">
        <p className={`font-semibold text-sm ${isPositive ? "text-green-500" : "text-gray-800"}`}>{amount}</p>
